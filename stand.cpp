...
int Stand::GetSignals1(double &h, double &v){
    ...
    //h = Jones1.norm();
    //v = Jones2.norm();
    h = pow(abs(Jones(0,0)),2)/100.0 * this->power_level;
    v = pow(abs(Jones(1,0)),2)/100.0 * this->power_level;
    return 1;
}
...
int Stand::GetSignals2(double &h, double &v){
    ...
    h = pow(abs(P3(0,0)),2) * this->power_level;
    v = pow(abs(P3(1,0)),2) * this->power_level;
